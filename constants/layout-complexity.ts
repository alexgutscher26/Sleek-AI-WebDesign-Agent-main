export const LAYOUT_COMPLEXITIES = [
  {
    value: "simple",
    label: "Simple",
    description: "Cleaner layouts with fewer sections, lower density, and more straightforward composition."
  },
  {
    value: "balanced",
    label: "Balanced",
  ...
  },
  {
    value: "complex",
    label: "Complex",
    description: "Richer composition with denser grids, more section interplay, and advanced layout choreography."
  }
] as const;
